...
$ANDROID_SDK_ROOT/build-tools/23.0.2/zipalign -v 4 platforms/android/build/outputs/apk/android-x86-release-unsigned.apk ./platforms/android/build/archives/TruckerLine_x86_122_rc1.apk
$ANDROID_SDK_ROOT/build-tools/23.0.2/zipalign -v 4 platforms/android/build/outputs/apk/android-armv7-release-unsigned.apk ./platforms/android/build/archives/TruckerLine_arm_122_rc1.apk
