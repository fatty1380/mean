(function () {
    ...
    var engagementCtrl = function ($scope, $state, registerService, $ionicPopup, $ionicLoading, cameraService, $ionicModal, $ionicActionSheet, userService) {
    ...
    engagementCtrl.$inject = ['$scope', '$state', 'registerService', '$ionicPopup', '$ionicLoading', 'cameraService', '$ionicModal', '$ionicActionSheet', 'userService' ];
