(function () {
    ...
    function cameraService( $q, $ionicActionSheet, modalService, userService) {
        ...
        function takePhoto (type) {
            ...
            getPicture(options).then(function(imageData) {
                if(imageData) {
                    vm.modal.show('avatarEdit');
                    vm.modal.rawImage = "data:image/jpeg;base64," + imageData;
        ...
        function updateAvatar(){
            vm.modal.finalImage = vm.modal.croppedImage;
            var dataProps = {
                props:{
                    avatar: vm.modal.finalImage
                }
            };
    ...
    cameraService.$inject = ['$q', '$ionicActionSheet', 'modalService', 'userService'];
