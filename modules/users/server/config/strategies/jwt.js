	...
	passport.use(new ClientPasswordStrategy(
		function (clientId, clientSecret, done) {
			...
			ClientApp.findOne({ clientId: clientId }, function (err, client) {
				...
				if (!client) {
					log.error({ strategy: 'client-password', clientId: clientId }, 'No client key found for clientId');
					return done(null, false);
				}
				if (client.clientSecret !== clientSecret) {
					log.error({ strategy: 'client-password', clientId: clientId }, 'Invalid client secret found for clientId');
					return done(null, false);
				}
